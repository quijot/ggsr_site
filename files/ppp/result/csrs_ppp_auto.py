...
__copyright__ = 'Copyright (c) 2017-2018, Justin Farinaccio,' \
...
parser = argparse.ArgumentParser(
    description='{0}'.format('# ---------------- Using CSRS-PPP via script, version 1.3.3 ---------------- #'),
...
if args.web:
    try:
        ...
        time.sleep(3)
        webbrowser.open('https://webapp.geod.nrcan.gc.ca/geod/tools-outils/ppp.php?locale={0}'.format(args.lang), new=2,
                        autoraise=True)
        sys.exit()
